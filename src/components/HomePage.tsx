    ...
    <div className="min-h-screen bg-[#0f0f1a]">
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 py-3 bg-[#0f0f1a]/85 backdrop-blur border-b border-[#1e1e2e]">
        <span className="flex items-center gap-1.5 font-bold text-base gradient-text-2">
          <IconDiamond size={20} className="text-violet-400" aria-hidden="true" />
          DailyGem
        </span>
          ...
          {profileOpen && (
            <div className="absolute top-12 right-0 bg-[#1e1e2e] border border-[#2d2d44] rounded-xl shadow-xl w-44 z-50 animate-fade-in-up overflow-hidden">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 text-left px-3 py-2 text-sm text-slate-300 hover:bg-[#2a2a3e] transition"
              >
      ...
      <main className="max-w-xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="rounded-2xl p-5 bg-gradient-to-br from-[#1e1b4b] to-[#312e81] border border-indigo-700/50 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <IconDiamond size={44} stroke={1.6} className="text-violet-300 animate-gem-pulse" aria-hidden="true" />
            <div>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-1 text-xs text-slate-400">
              連續天數 <IconFlame size={14} className="text-amber-400" aria-hidden="true" />
            </div>
          </div>
        </div>
        ...
        {answeredToday ? (
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-5 flex items-center gap-4">
            <IconCircleCheck size={34} className="text-emerald-400" aria-hidden="true" />
            <div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              <span className="flex items-center gap-1 text-xs font-semibold bg-violet-500/20 text-violet-300 px-2.5 py-1 rounded-full">
                <IconSparkles size={14} aria-hidden="true" />
                今日一問
              </span>
              <span className="flex items-center gap-1 text-xs bg-violet-500/15 text-violet-300 font-semibold px-2.5 py-1 rounded-full">
            ...
            <div className="flex justify-end mt-3">
              <span className="flex items-center gap-1 text-slate-500 group-hover:text-violet-400 transition text-sm">
...
function AnswerCard({ record }: { record: AnswerRecord }) {
  return (
    <div className="bg-[#1e1e2e] border border-[#2d2d44] rounded-xl p-4">
      ...
      <p className="flex items-center gap-1 text-xs text-violet-400 font-semibold mt-2">
